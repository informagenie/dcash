...
<div class="container-fluid">
            ...
            <div class="navbar-header">
                <div class="navbar-brand">
                    <div class="navbar-title">
                        <a href="<?= E_COMMERCE_HOST ?>"><img width="100"
    ...
    <div class="container">
        ...
        <?php if (isset($_SESSION['errors'])): ?>
            ...
            <?php endforeach ?>
        <?php endif ?>
        <form id="order_purchase" class="col-xs-12 col-md-6 col-md-offset-3" action="./order/process" method="post">
            <legend class="right">
                Mode de paiement <img src="<?= site_url('assets/images/payment.png') ?>" alt="">
            </legend>
            <legend>Envoyez <?= $__montant ?>$ au numero : <strong><span
                        id="__n"><?= radicalise_number($numbers['mpesa']['info_value']) ?></span></strong></legend>
            <div class="form-group">
                ...
                <select class="form-control" name="<?= crypter('__phone_number') ?>" id="phone_number">
                    ...
                    <?php foreach ($numbers as $number): ?>
                        <?php if (!empty($number['info_value'])): ?>
                            <option <?= (what_service($number['info_value']) == VODACOM) ? 'selected' : '' ?>
                                value="<?= $number['info_value'] ?>"><?= radicalise_number($number['info_value']) ?>
                                (<?= $number['info_name'] ?>)
                            </option>
                        <?php endif ?>
                    <?php endforeach ?>
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    <input class="form-control" readonly value="<?= $__montant ?>" type="text"
                           name="<?= crypter('__montant') ?>" id="">
            ...
            <div class="form-group">
                ...
                <input autocomplete="off" maxlength="10" required pattern="[a-zA-Z0-9]{10}" class="form-control"
                       type="text" name="<?= crypter('__ref') ?>">
            </div>
            ...
            <div class="row">
                <div class="col-md-6 col-sm-6">
                    <button class="btn btn-primary form-control" type="submit"><span
                            class="glyphicon glyphicon-check"></span>Valider
                    </button>
                </div>
                <div class="col-md-6 col-sm-6">
                    <a class="form-control btn btn-danger" href="<?= $options['cancel_return'] ?>">Annuler</a>
                </div>
            </div>
        </form>
    </div>
...
<script src="<?php echo base_url(); ?>assets/js/order.js" type="text/javascript"></script>
</body>
</html>
