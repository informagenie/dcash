                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="password" class="form-control" id="password" placeholder="Mot de passe" name="password" maxlength="10">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="cpassword">Confirmation mot de passe</label>
                                        <input type="password" class="form-control" id="cpassword" placeholder="Confirmation mot de passe" name="cpassword" maxlength="10">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="mobile" placeholder="Téléphone" name="mobile" value="<?php echo $mobile; ?>" maxlength="10">
                                    </div>
                                </div>
                                            ...
                                            <select class="form-control" id="role" name="role">
                                                ...
                                                if (!empty($roles)) {
                                                    foreach ($roles as $rl) {
                                                        ?>
                                                        <option
                                                            value="<?php echo $rl->roleId; ?>" <?php if ($rl->roleId == $roleId) {
